import { Mail, Phone, MapPin, Linkedin, Globe, BriefcaseBusiness, GitBranchIcon } from "lucide-react";
                        ...
                        {data.projects.map((proj, index) => (
                            <div key={index} className="flex justify-between items-start border-l-3 border-gray-300 pl-6">
                                <div>
                                    ...
                                    {/* Project Type Badge */}
                                    {proj.type && (
                                        <span className="text-[10px] uppercase tracking-wider border border-gray-400 px-2 py-0.5 rounded text-gray-500 font-medium">
                                            {proj.type}
                                        </span>
                                    )}
                                    {/* Project Links */}
