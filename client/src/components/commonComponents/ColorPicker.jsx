...
export const ColorPicker = ({selectedColor,onChange}) => {
    ...
    return (
        <div className='relative'>
            <button onClick={() => setIsOpen((prev) => !prev)} className=' flex items-center gap-1 text-sm text-purple bg-gradient-to-br from-purple-50 to-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
                <Palette size={16} />
